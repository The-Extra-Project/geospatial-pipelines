...
def get_lattice_grid_loader(dataset, num_threadworkers=8):
    r"""
    instantiates the dataloader on top of the torch in order to fetch the data to the mode for training purposes.
