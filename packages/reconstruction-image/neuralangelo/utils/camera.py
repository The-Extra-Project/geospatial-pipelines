"""
credits to nvidia [neuralangelo](https://github.com/NVlabs/neuralangelo/blob/main/imaginaire/trainers/utils/cameras.py) for full reference.  this is for the use of non commercial (demonstration) usecase only. 
translates the photos processed by the colmap into the tensor models.
"""
